    ...
    <div className="banner-container">
      <div className="left-container">
        ...
        <div className="thumb-container">
            ...
            <button className='button-thumb' onClick={changeImage2}>
              <img className="thumbnail" src={image.thumbnailUrl} alt="" />
            </button>
            <button className='button-thumb' onClick={changeImage3}>
              <img className="thumbnail" src={image.thumbnailUrl} alt="" />
            </button>
            <button className='button-thumb' onClick={changeImage4}>
              <img className="thumbnail" src={image.thumbnailUrl} alt="" />
            </button>
        </div>
      </div>
